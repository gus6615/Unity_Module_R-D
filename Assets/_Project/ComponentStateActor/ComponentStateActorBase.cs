...
{
    public abstract class ComponentStateActor<T> : MonoBehaviour where T : Object
    {
        [SerializeField] private MonoBehaviour target;
        [SerializeField] private SerializableDictionary<string, ComponentStateData> stateDataDict;
